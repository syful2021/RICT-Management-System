                    ...
                    @foreach ($mentors as $key => $data)
                        <tr>
                            ...
                            <td class="p-3 border-b border-[#ebedf2] dark:border-[#191e3a] text-center h-14 w-14">
                                ...
                                @else
                                    <div class="text-center">
                                        ...
                                        src="{{ asset('storage/' . $data->image) }}" alt="image" />
                                    </div>
                                @endif
                            </td>
                            ...
                            <td class="p-3 border-b border-[#ebedf2] dark:border-[#191e3a] text-center">
                                ...
                                <button type="button" wire:click="ShowUpdateModel({{ $data->id }})">
                                ...
                                <button type="button" wire:click="deleteAlert({{ $data->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
